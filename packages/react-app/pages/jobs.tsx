  ...
  const jobs: Job[] = [
    {
      ...
      desc: "Currently, MiniSafe is seeking a motivated, career and customer-oriented Software Developer to join our team in Fort Meade, MD.",
      date: "May 17, 2023",
      salary: "98,000 USD",
      type: "Full-time",
          ...
          <li key={idx} className="p-5 bg-white rounded-md shadow-sm">
              <div>
                ...
                <div className="mt-4 items-center space-y-4 text-sm sm:flex sm:space-x-4 sm:space-y-0">
                  <span className="flex items-center text-gray-500">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
                      <path fillRule="evenodd" d="M6 6V5a3 3 0 013-3h2a3 3 0 013 3v1h2a2 2 0 012 2v3.57A22.952 22.952 0 0110 13a22.95 22.95 0 01-8-1.43V8a2 2 0 012-2hzm2-1a1 1 0 011-1h2a1 1 0 011 1v1H8V5zm1 5a1 1 0 011-1h.01a1 1 0 110 2H10a1 1 0 01-1-1z" clipRule="evenodd" />
                    </svg>
                    {item.type}
                  </span>
                  <span className="flex items-center text-gray-500">
