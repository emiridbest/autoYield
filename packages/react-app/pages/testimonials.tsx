...
const testimonials: Testimonial[] = [
    {
        ...
        name: "Martin escobar",
        title: "Founder of Lubot",
        quote: "Your saving todat will save you tomorrow."
    },
    {
        avatar: "https://randomuser.me/api/portraits/men/46.jpg",
        name: "Simon andrew",
        title: "Software engineer",
        quote: "Saving is living, if you stop saving, you start dying."
    },
    {
        ...
        <div className="relative z-10 max-w-screen-xl mx-auto px-4 md:px-8">
            <div className="max-w-xl sm:text-center md:mx-auto">
                ...
                <p className="mt-3 text-gray-600">
                    MiniSafe is still touching lives, changing destinies and impacting daily living                </p>
            </div>
            <div className="mt-12">
                        ...
                        <li key={idx} className="bg-white rounded-xl border shadow-md">
                            ...
                            <figure>
                                ...
                                <div className="flex items-center gap-x-4 p-4 mt-6 bg-indigo-50">
                                    <img src={item.avatar} className="w-16 h-16 rounded-full border-2 border-indigo-500" alt={item.name} />
                                    <div>
